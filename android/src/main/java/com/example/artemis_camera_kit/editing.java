...
//
//class CameraView implements PlatformView, CameraViewInterface, MethodChannel.MethodCallHandler,ZXingScannerView.ResultHandler, FlutterMethodListener {
...
//                if (mScannerView == null) mScannerView =new ZXingScannerView(context);
...
//        onBarcodeRead(rawResult.getText());
